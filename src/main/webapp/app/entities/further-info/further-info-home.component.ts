...
@Component({
  selector: 'jhi-further-info-home',
  templateUrl: './further-info-home.component.html',
  styleUrls: ['further-info-home.scss']
})
export class FurtherInfoHomeComponent implements OnInit, OnDestroy {
