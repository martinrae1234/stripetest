...
describe('Service Tests', () => {
  describe('HomePage Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(HomePageService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new HomePage(0, 0, TypeOfProject.GENERALFUNDRAISING);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of HomePage', () => {
        const returnedFromService = Object.assign(
          {
            costOfFeedingAChild: 1,
            typeOfProject: 'BBBBBB'
